...
def main():
    ...
    parser.add_argument('-d', '--permsdir', nargs=1, default=['perms'], help='path to the permissions directory')
    ...
    for d in args.permsdir[0], args.permsdir[0] + '/' + args.function[0]:
        safe_mkdir(d)
  
    if args.passwords and not args.envtype:
        die("-P requires -t")
  
    store_mysql_version(args.permsdir[0] + '/' + args.function[0], conn)
  
    gen_users_from_db(args.permsdir[0] + '/' + args.function[0], conn, args)
